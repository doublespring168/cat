        ...
        <th>
            ...
            <div class="input-group" style="float:left;width:350px">
                ...
                <form id="wrap_search2" style="margin-bottom:0px;">
						<span class="input-icon" style="width:350px;">
							<input type="text" placeholder="input domain for search"
                                   class="search-input search-input form-control ui-autocomplete-input" id="command2"
                                   autocomplete="on" data=""/>
							<i class="ace-icon fa fa-search nav-search-icon"></i>
						</span>
                </form>
...
<div>&nbsp;
    <label class="btn btn-info btn-sm"><input type="radio"
                                              name="typeCheckbox" value="request">请求数
                                                       ...
                                                       name="typeCheckbox" value="success">网络成功率</label><label
        ...
        <tr class="right">
                ...
                <c:when test="${empty networkCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('network', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty appVersionCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('app-version', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty channelCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('connect-type', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty platformCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('platform', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty cityCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('city', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty operatorCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('operator', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty sourceCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('source', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}','${sourceCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
