...
<a:mobile>
    ...
    <table width="100%">
        ...
        <tr>
            <td>
                <div id="operatorChart" style="width:40%; height: 400px"></div>
            </td>
            <td>
                <div id="versionChart" style="width:40%; height: 400px"></div>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <script type="text/javascript">
        ...
        function getTime() {
            var myDate = new Date();
            var myHour = Number(myDate.getHours());
            var myMinute = Number(myDate.getMinutes());
