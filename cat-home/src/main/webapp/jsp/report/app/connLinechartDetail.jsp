        ...
        <tr class="right">
                ...
                <c:when test="${empty networkCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('network', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty appVersionCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('app-version', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty channelCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('connect-type', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty platformCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('platform', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty cityCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('city', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
            ...
            <c:choose>
                <c:when test="${empty operatorCode}">
                    <td>
                        <button class="btn btn-xs btn-info"
                                onclick="query('operator', '${networkCode}','${appVersionCode}','${channelCode}','${platformCode}','${cityCode}','${operatorCode}');">
                            展开⬇
                        </button>
                    </td>
                </c:when>
