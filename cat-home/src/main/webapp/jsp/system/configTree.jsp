...
<div class="well sidebar-nav">
    <ul class="nav nav-list">
        ...
        <li class="text-left" id="metricRuleConfigUpdate"><a href="?op=metricRuleConfigUpdate" style="display:none">业务全局规则</a>
        </li>
        <li class="text-left" style="display:none" id="domainMetricRuleConfigUpdate"><a
                href="?op=domainMetricRuleConfigUpdate">业务XML规则</a></li>
