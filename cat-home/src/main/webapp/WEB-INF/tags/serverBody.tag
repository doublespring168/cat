    ...
    <div class="main-container" id="main-container">
        ...
        <div id="sidebar" class="sidebar responsive">
            ...
            <ul class="nav nav-list" style="top: 0px;">
                <li id="serverChart" class="hsub"><a href="#" class="dropdown-toggle"> <i
                        class="menu-icon fa fa-desktop"></i> <span class="menu-text">Servers</span>
                    ...
                    <ul class="submenu">
                        ...
                        <li id="serverGraph"><a
                                href="/cat/r/server?domain=${model.domain}&graphId=${payload.graphId}&op=graph">
                ...
                <li id="serverConfig" class="hsub"><a href="#" class="dropdown-toggle"> <i
                        class="menu-icon fa fa-cogs"></i> <span class="menu-text">Config</span>
                    <b class="arrow fa fa-angle-down"></b>
                </a> <b class="arrow"></b>
                    <ul class="submenu">
