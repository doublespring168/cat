            ...
            if (!f_anchor && !t_anchor) {
                if (y1 < y2) {
                    conn[id + '-in'] = {
                        ...
                        'x2': (x1 + x2 - 40) / 2,
                        'y2': (y1 + y2) / 2,
                        'data': [inData, indiscards, inerrors],
                        'name': to,
                        'fill': infill,
                        'state': instate,
                        'discardsstate': indiscardsstate,
                        'errorsstate': inerrorsstate
                    };
                    ...
                    conn[id + '-out'] = {
                        ...
                        'x2': (x1 + x2 + 40) / 2,
                        'y2': (y1 + y2) / 2,
                        'data': [outData, outdiscards, outerrors],
                        'name': to,
                        'fill': outfill,
                        'state': outstate,
                        'discardsstate': outdiscardsstate,
                        'errorsstate': outerrorsstate
                    };
