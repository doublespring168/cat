...
public class XmlModelBuilder implements ModelBuilder {
    ...
    enum XmlBuilder {
        ENTITY {
            ...
            public void build(StringBuilder sb, String tag, Object value) {
                ...
                if (model.trim().endsWith("/>")) {
                    sb.append("<").append(tag).append(model, off, pos3 + 1).append(">\r\n");
                } else if (off >= 0) {
                    sb.append("<").append(tag).append(model, off, pos3 + 1).append(tag).append(">\r\n");
                } else {
        ...
        ATTRIBUTE {
            @Override
            public void build(StringBuilder sb, String tag, Object value) {
                sb.append(' ').append(tag).append("=\"").append(escape(value, false)).append("\"");
            }
        },
        ...
        ELEMENT {
            @Override
            public void build(StringBuilder sb, String tag, Object value) {
                sb.append('<').append(tag).append('>').append(escape(value, true)).append("</").append(tag)
                        .append(">\r\n");
            }
        };
